...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تطبيق حُضور لإدارة اشتراكات وحضور الأنشطة الرياضية والأكاديميات بذكاء وسهولة." },
      { name: "theme-color", content: "#14B8A6" },
      { property: "og:title", content: "حُضور — إدارة الحضور والحصص بذكاء" },
      { property: "og:description", content: "نظام متكامل لإدارة المشتركين والأنشطة والحضور." },
