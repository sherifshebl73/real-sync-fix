  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4" dir="rtl">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">الصفحة التي تبحث عنها لا وجود لها.</p>
        <div className="mt-6">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "حُضور — إدارة الحضور والحصص بذكاء" },
      { name: "twitter:description", content: "نظام متكامل لإدارة اشتراكات وحضور الأنشطة الرياضية والأكاديميات." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d2caf75a-413e-47cf-9137-f1641d167401/id-preview-6977fa24--3eeacb4d-9dd7-4579-8975-c5148abcea02.lovable.app-1784896700805.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d2caf75a-413e-47cf-9137-f1641d167401/id-preview-6977fa24--3eeacb4d-9dd7-4579-8975-c5148abcea02.lovable.app-1784896700805.png" },
    ],
    links: [
